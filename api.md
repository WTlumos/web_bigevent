...
## 根据 Id 删除文章分类`/my/article/deletecate/:id`
...
## 根据 Id 获取文章分类数据 `/my/article/cates/:id`
...
## 根据 Id 删除文章数据`/my/article/delete/:id`
